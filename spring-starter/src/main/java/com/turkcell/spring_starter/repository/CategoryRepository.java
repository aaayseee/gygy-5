...
public interface CategoryRepository extends JpaRepository<Category, UUID>
{
    ...
    // 3. Named Queries
    Set<Category> findByNameLike(String name); //name queriesler çok tercih edilmez çünkü bizim müdahale etmemiz gereken bir alan var. O yüzden genelde JPQL veya SQL tercih edilir.
}
